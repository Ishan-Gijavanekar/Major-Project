...
export const useTransactionStore = create((set, get) => ({
    ...
    createStripePaymentIntent: async (data) => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.post("/transactions/createStripePaymentIntent", data);
            return res.data;
        } catch (error) {
    ...
    confirmStripePayment: async (data) => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.post("/transactions/confirmStripePayment", data);
            return res.data;
        } catch (error) {
    ...
    refundStripePayment: async (data) => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.post("/transactions/refundStripePayment", data);
            return res.data;
        } catch (error) {
    ...
    createManualTransaction: async (data) => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.post("/transactions/createManualTransaction", data);
            return res.data;
        } catch (error) {
    ...
    getTransactionById: async (id) => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.get(`/transactions/getTransactionById/${id}`);
            return res.data;
        } catch (error) {
    ...
    getAdminTransactionStats: async () => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.get("/transactions/getAdminTransactionStats");
            return res.data;
        } catch (error) {
    ...
    updateTransactionStatus: async (id, data) => {
        try {
            set({ isLoading: true });
            const res = await axiosInstance.put(`/transactions/updateTransactionStatus/${id}`, data);
            return res.data;
        } catch (error) {

...
import { DollarSign, FileText, Users, Loader, Briefcase, CheckCircle, Clock, CreditCard } from 'lucide-react';
    ...
    <div className={`min-h-screen bg-gray-50 p-8 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-lg">Overview of platform statistics and analytics</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-sm font-medium text-gray-500 mb-1">Pending Contracts</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-gray-500 mt-1">{pendingProposals} pending</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-gray-500 mt-1">{formatCurrency(totalTransactionAmount)}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-sm p-6 text-white">
            <div className="flex items-center justify-between mb-2">
              <p className="text-blue-100 text-sm font-medium">Avg Revenue/Contract</p>
              <DollarSign size={20} className="text-blue-200" />
            </div>
            <p className="text-3xl font-bold">{formatCurrency(avgRevenuePerContract)}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-sm p-6 text-white">
            ...
            <p className="text-3xl font-bold">{verifiedUsers} / {totalUsers}</p>
          </div>

          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-sm p-6 text-white">
            <div className="flex items-center justify-between mb-2">
              <p className="text-purple-100 text-sm font-medium">Pending Proposals</p>
          ...
          <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl shadow-sm p-6 text-white">
            <div className="flex items-center justify-between mb-2">
              <p className="text-cyan-100 text-sm font-medium">Avg Transaction</p>
              <CreditCard size={20} className="text-cyan-200" />
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-semibold text-gray-600 uppercase">Acceptance Rate</h4>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-semibold text-gray-600 uppercase">User Verification</h4>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-semibold text-gray-600 uppercase">Transaction Summary</h4>
              <CreditCard className="text-cyan-500" size={20} />
            </div>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Count:</span>
                <span className="text-lg font-bold text-gray-900">{totalTransactions}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Total Value:</span>
                <span className="text-lg font-bold text-gray-900">{formatCurrency(totalTransactionAmount)}</span>
              </div>
            </div>
          </div>
        </div>

...
const GetAllProposals = () => {
  ...
  const { adminGetAllPraposals, isLoading } = usePraposalStore();
  ...
  const fetchProposals = async () => {
    try {
      const response = await adminGetAllPraposals();
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Freelancer</th>
                    ...
                    <tr key={proposal._id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="text-sm font-medium text-gray-900">{proposal.freelancer?.name || 'Unknown'}</div>
